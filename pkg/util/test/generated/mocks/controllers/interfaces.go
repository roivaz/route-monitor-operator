...
func (mr *MockServiceMonitorHandlerMockRecorder) DeleteServiceMonitorDeployment(serviceMonitorRef, smType interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteServiceMonitorDeployment", reflect.TypeOf((*MockServiceMonitorHandler)(nil).DeleteServiceMonitorDeployment), serviceMonitorRef, smType)
}
...
func (mr *MockServiceMonitorHandlerMockRecorder) TemplateAndUpdateServiceMonitorDeployment(url, blackBoxExporterNamespace, namespacedName, clusterID, smType, useInsecure, owner interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockServiceMonitorHandler) UpdateServiceMonitorDeployment(template client.Object) error {
	m.ctrl.T.Helper()
